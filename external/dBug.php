	...
	function initJSandCSS() {
		echo <<<SCRIPTS
			...
			<style type="text/css">
				...
				table.dBug_array td { background-color:#FFFFFF; color: #000;}
				...
				table.dBug_object td { background-color:#FFFFFF; color: #000; }
				...
				table.dBug_resourceC td { background-color:#FFFFFF; color: #000; }
				...
				table.dBug_resource td { background-color:#FFFFFF; color: #000; }
				...
				table.dBug_xml td { background-color:#FFFFFF; color: #000; }
